...
public class WarrantyYearsValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable {
    ...
    protected Collection<FieldValue> createFieldValue(ProductModel product, IndexConfig indexConfig, IndexedProperty indexedProperty) {
        ...
        Integer warrantyYears = product.getWarrantyYears();
